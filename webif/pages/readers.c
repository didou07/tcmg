...
void send_page_readers(int fd)
{
    ...
    pos=buf_printf(&buf,&bsz,pos,
        ...
        "<th data-k='label'><button type='button' class='table-sort'>Reader<span class='sort-arrow' aria-hidden='true'></span></button></th>"
    ...
    if(n==0) pos=buf_printf(&buf,&bsz,pos,"<tr class='erow'><td colspan='9'>No readers configured yet.</td></tr>");
    ...
    pos=buf_printf(&buf,&bsz,pos,
        ...
        "<div class='shd'><div class='stl'>Reader settings</div></div>"
